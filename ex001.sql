...
SELECT 
    id_empresa, nome, setor, num_funcionarios # pode ser selecionado na mesma linha ou dividir o código em linhas
FROM
    resultados;
...
SELECT *
FROM resultados 
WHERE setor = 'Energia'; #Total de empresas por setor: Tecnologia 43 empresas, Energia 57 empresas